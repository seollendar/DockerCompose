...
var topic = 'partition2Topic';//TwoAEpairsNotifi, notiTopic
const SEND_COUNT = 100000; //50000 100000

function Emulator() {
    for(var i=50000; i<SEND_COUNT; i++){
        if(i%2 == 0){
            partitionNum = 0
        }else{
            partitionNum = 1
        ...
        let ntelsData = {
                    "m2m:sgn": {
                     ...
                     "vrq": false,
                     "sud": false,
                     "sur": `/~/CB00061/smartharbor/Device${i}/scnt-location/sub-S01228427453_user`,
